...
try:
    ...
    target_names = {
        "check_analysis_portable",
        "get_analysis_runtime_config",
        "get_self_contained_runtime_status",
        "_get_server_status_info",
        "list_runs_with_mcs",
        "list_map_explorer_runs",
        "get_analysis_exposure_models",
        "_resolve_mc_store_paths",
        "_build_map_geometry",
        "_build_map_timeseries",
        "discover_runs",
        "run_detail",
        "tail_log",
        "_parse_log_lines",
    ...
    missing_targets = [t for t in target_names if t not in functions]
